...
export default function OfferDetail() {
  ...
  if (!offer) {
    return (
      <div className="text-center py-12">
        ...
        <Link to="/categories" className="text-blue-600 hover:underline mt-2 inline-block">Back to Categories</Link>
      </div>
    );
  }
  ...
  // Using Google Maps embed without API key (simpler approach)
              ...
              <div className="space-y-4">
                ...
                {shop.area && (
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Pune: {shop.area.name}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              {offer.category && (
                <div>
                  ...
                  <p className="text-gray-600">{offer.category.name}</p>
                </div>
              )}
            </div>
          </div>
